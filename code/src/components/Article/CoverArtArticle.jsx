...
import coverArt1High from "../../images/covers/ah-dance-single-cover.jpg"
import coverArt2High from "../../images/covers/ah-youmore-single-cover.jpg"
import coverArt3High from "../../images/covers/ah-true_north-ep-cover.jpg"
import coverArt4High from "../../images/covers/ah-mount_foreverest-album-cover.jpg"
import coverArt5High from "../../images/covers/ah-metro-ep-cover.jpg"

const CoverArtArticle = () => {
  const data = useStaticQuery(graphql`
    query coverArtQuery {
      cover1: file(relativePath: { eq: "covers/ah-dance-single-cover.jpg" }) {
        childImageSharp {
          fluid {
      ...
      cover2: file(relativePath: { eq: "covers/ah-youmore-single-cover.jpg" }) {
        childImageSharp {
          fluid {
            ...GatsbyImageSharpFluid
          }
      ...
      cover3: file(relativePath: { eq: "covers/ah-true_north-ep-cover.jpg" }) {
        childImageSharp {
          fluid {
            ...GatsbyImageSharpFluid
          }
      ...
      cover5: file(relativePath: { eq: "covers/ah-metro-ep-cover.jpg" }) {
        childImageSharp {
          fluid {
            ...GatsbyImageSharpFluid
          }
